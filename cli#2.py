...
# from core.extractor2 import extract_terms
from core.extractor3 import extract_terms
from core.glossary2 import check_against_glossary
import pandas as pd
...
def main():
    ...
    terms_df = extract_terms(df)
    final_df = check_against_glossary(terms_df, glossary)
    console.print(f"[yellow]Extracted {len(final_df)} candidate terms")

    output_path = "output/ZGAME-Glossary-Candidates4.xlsx"
